...
static unsigned int indL4=20;
static unsigned int indL5=10;

//character arrays for sprintf
char userScore [2] = "";
char highScore [2] = "";

//pin # for buzzer
const int buzzPin=37;
...
static void handleWin()
{
  ...
  OrbitOledMoveTo(0,indL2);
  OrbitOledDrawString("New High Score!!");

  if (dowin){
    tone (buzzPin, freqwin);
    delay(delTone);
    noTone(buzzPin);
